...
public:
	...
	void ApplyChams(IMaterial* matt, std::string color, float alpha, int material_flag, bool flag_value, uintptr_t ctx, const DrawModelState_t& state, const ModelRenderInfo_t& info, matrix3x4_t* bone, bool chams_background = false);
