...
public:
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_szLastPlaceName;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_bShouldGlow;
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_iPing;
    ...
    void init( ) {
        ...
        INIT_XOREDNETVAR( m_iPing,                      HASH( "DT_CSPlayerResource" ),       HASH( "m_iPing" ) );
        //INIT_XOREDNETVAR( m_iPing,                      HASH( "DT_PlayerResource" ),       HASH( "m_iPing[1]" ) );
        //INIT_XOREDNETVAR( m_iPing,                      HASH( "DT_PlayerResource" ),       HASH( "m_iPing[0]" ) );
        //INIT_XOREDNETVAR( m_iPing,                      HASH( "DT_PlayerResource" ),       HASH( "m_iPing[2]" ) );
        ...
        INIT_XOREDNETVAR(m_bShouldGlow, HASH("DT_DynamicProp"), HASH("m_bShouldGlow"));
